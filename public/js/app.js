...
/***/ "./resources/js/announceImages.js":
/*!****************************************!*\
  !*** ./resources/js/announceImages.js ***!
  \****************************************/
/***/ (() => {
...
__webpack_require__(/*! ./announceImages */ "./resources/js/announceImages.js");

__webpack_require__(/*! ./rps */ "./resources/js/rps.js");
...
var userScore = 0;
var cpuScore = 0;
var userScoreP = document.getElementById('user-score');
var cpuScoreP = document.getElementById('cpu-score');
...
var cpuBox = document.querySelector('.cpu-box');
...
function game(userChoice) {
  ...
  if (computerChoice === 'r') {
    cpuBox.innerHTML = "<i class=\"far fa-hand-rock fa-3x\"></i>";
  }

  ;

  if (computerChoice === 'p') {
    cpuBox.innerHTML = "<i class=\"far fa-hand-paper fa-3x\"></i>";
  }

  ;

  if (computerChoice === 's') {
    cpuBox.innerHTML = "<i class=\"far fa-hand-scissors fa-3x\"></i>";
  }

  ;

  if (userChoice === 'r') {
    userBox.innerHTML = "<i class=\"far fa-hand-rock fa-3x\"></i>";
  }

  ;

  if (userChoice === 'p') {
    userBox.innerHTML = "<i class=\"far fa-hand-paper fa-3x\"></i>";
  }

  ;

  if (userChoice === 's') {
    userBox.innerHTML = "<i class=\"far fa-hand-scissors fa-3x\"></i>";
  }
